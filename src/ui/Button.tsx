...
export const Button = forwardRef<HTMLButtonElement, Props>(
  ({ variant = "ghost", size = "md", className = "", ...props }, ref) => {
    const base =
      "inline-flex items-center justify-center gap-2 nb-heavy-border border transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-[var(--accent-main)] disabled:opacity-50 disabled:cursor-not-allowed";

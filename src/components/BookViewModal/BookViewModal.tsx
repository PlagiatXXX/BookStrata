      ...
      <div className="relative flex max-h-[90vh] w-full flex-col gap-5 bg-[var(--bg-1)] p-6 text-[var(--ink-0)]">
        ...
        <div className="flex-1 overflow-y-auto pr-1">
          ...
          {book.thoughts && book.thoughts.trim() && (
            <div className="mt-6 flex min-w-0 flex-col gap-2 border-t border-[var(--line-soft)] pt-5">
        ...
        <div className="flex shrink-0 justify-end border-t border-[var(--line-soft)] pt-4">
          <Button variant="primary" onClick={onClose} className="rounded-[6px]">
            Закрыть
          </Button>
        </div>
      </div>

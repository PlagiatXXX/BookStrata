...
export function ClearAllModal({ isOpen, onClose, onConfirm }: ClearAllModalProps) {
  return (
    <Modal isOpen={isOpen} onClose={onClose} maxWidth="sm" titleId="clear-all-title">
      <div className="relative flex flex-col items-center p-6 text-center text-[#d8f9ff]">
        ...
        <h3 id="clear-all-title" className="mb-2 text-xl font-bold tracking-[-0.02em] text-[#e8ffff]">
          Очистить все тиры?
        </h3>

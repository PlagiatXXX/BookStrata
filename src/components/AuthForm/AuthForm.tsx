      ...
      <div className="relative min-h-screen overflow-hidden">
        <div className="absolute inset-0">
          <video autoPlay muted playsInline className="hidden md:block absolute inset-0 w-full h-full object-cover">
            <source src="/library4k-hq-full.mp4" type="video/mp4" />
          </video>
        ...
        <div className="relative z-10 flex min-h-screen items-center justify-center p-4">
          <Card className="w-full max-w-sm md:max-w-md bg-white/25 backdrop-blur-xs shadow-[0_20px_60px_rgba(0,0,0,0.25)] border border-white/30">
            ...
            <form key={mode} onSubmit={handleSubmit} autoComplete="on" className="space-y-4 md:space-y-5">
            ...
            <div className="mt-4 space-y-2">
                ...
                <div className="flex justify-center gap-3">
                  <span
                    ...
                    title="В разработке"
                  >
                    <span className="flex items-center justify-center size-9 rounded-full border border-slate-300/60 opacity-50 cursor-not-allowed">
                    ...
                    <span className="absolute bottom-full mb-2 hidden group-hover:block whitespace-nowrap rounded bg-slate-800 px-2 py-1 text-xs text-white shadow-lg">
                      В разработке
                    </span>
                  </span>
                  <span

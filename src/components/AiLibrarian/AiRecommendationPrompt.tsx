  ...
  return (
    ...
    >
      ...
      <div className="flex items-start gap-4">
        {/* Иконка */}
        <div className="mt-0.5 flex size-10 shrink-0 items-center justify-center rounded-lg bg-violet-500/10">
        ...
        <button
          type="button"
          onClick={handleOpen}
          className="shrink-0 rounded-lg bg-violet-500/10 px-4 py-2 text-xs font-semibold text-violet-300 transition-all hover:bg-violet-500/20 hover:text-violet-200 cursor-pointer"
        >
          Посмотреть
        </button>

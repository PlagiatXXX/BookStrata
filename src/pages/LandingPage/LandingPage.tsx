  ...
  return (
    <nav className="landing-nav">
      <div className="landing-nav__inner">
        ...
        >
          <button
            data-analytics="nav.landing.features"
          ...
          <button
            data-analytics="nav.landing.featured"
          ...
          <Link
            data-analytics="nav.landing.rankings"
            to="/rankings"
            className="landing-nav__link"
          >
            Рейтинг книг
          ...
          <Link
            data-analytics="nav.landing.celebrities"
            to="/celebrities"
            className="landing-nav__link"
          >
            Знаменитости
          ...
          <div className="landing-nav__auth">
            <button
              data-analytics="auth.login_landing"
            ...
            <button
              data-analytics="auth.register_landing"
              onClick={() => navigate("/auth?mode=register&redirect=/")}
              className="landing-nav__cta landing-nav__cta--primary"
              type="button"
            >
              Регистрация
            </button>
      ...
      <section className="landing-hero">
        ...
        <div className="landing-hero__content">
          ...
          <p className="landing-hero__subtitle">
            Создавайте тир-листы, ведите личную библиотеку, находите книги по
            вкусу с&nbsp;ИИ и общайтесь с&nbsp;единомышленниками.
          </p>

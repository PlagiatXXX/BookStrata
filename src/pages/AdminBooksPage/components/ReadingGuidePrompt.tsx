...
6. target_audience: по 1–2 предложения (каждое до 300 символов) о ком这本书 зацепит.
   friction_points: 1–2 предложения о конкретных элементах, которые могут оттолкнуть
   (темп, тропы, стиль, отсутствие ожидаемого). Не тавтология вида «не для любителей фэнтези»,
   а конкретика: «медленный темп первых 100 страниц», «много политических интриг вместо экшена»,
   «нет романтической линии несмотря на тег 'романтика'».
...
ФОРМАТ ВЫХОДНЫХ ДАННЫХ (заполни значения, структуру не меняй):
{
  ...
  "friction_points": "<конкретные элементы, которые могут оттолкнуть>",

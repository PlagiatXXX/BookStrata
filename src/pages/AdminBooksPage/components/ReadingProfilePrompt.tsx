...
06. complexity (Доступное ↔ Многослойное)
  0–20 — доступное. Простой синтаксис, «проглатывается за вечер».
...
const AXIS_RUBRICS = [
  {
    ...
    rows: [
      ...
      { range: "60–80", desc: "Рефлексия доминирует. События — повод для размышлений." },
  ...
  },
  {
    ...
    rows: [
      { range: "0–20", desc: "Стрелочная скорость. Главы по 5 страниц." },
  ...
  {
    name: "scope",
    label: "Камерное ↔ Эпическое",
    rows: [
      { range: "0–20", desc: "Камерное. Одна комната, одна семья, локальный масштаб." },
      { range: "20–40", desc: "Небольшой мир. Узкий круг персонажей, локальный конфликт." },
      { range: "40–60", desc: "Средний масштаб. Несколько локаций, развёрнутый сюжет." },
      { range: "60–80", desc: "Широкий мир. Много персонажей, масштабные события." },
      { range: "80–100", desc: "Эпическое. Галактики, империи, десятки фракций и поколений." },
    ],
  },
  {
    name: "complexity",
    label: "Доступное ↔ Многослойное",
    rows: [
      { range: "0–20", desc: "Доступное. Простой синтаксис, «проглатывается за вечер»." },
      { range: "20–40", desc: "Лёгкое чтение. Несложный язык, но интересная подача." },
      { range: "40–60", desc: "Средняя сложность. Есть стилистика, но без перегруза." },
      { range: "60–80", desc: "Многослойное. Богатая стилистика, метафоры, интертекст." },
      { range: "80–100", desc: "Высокая сложность. Модернистская форма, экспериментальный язык." },
    ],
  },
];

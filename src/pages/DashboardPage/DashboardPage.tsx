...
import { ActivityChart } from "@/components/DashboardHeroSection/components/ActivityChart";
import { LevelCard } from "@/components/DashboardHeroSection/components/LevelCard";
import { AchievementsPanel } from "@/components/DashboardHeroSection/components/AchievementsPanel";
...
export default function DashboardPage() {
  ...
  const [activeStat, setActiveStat] = useState<
    "tierlists" | "published" | "drafts" | "books" | null
  >(null);
  ...
  const tierListsSectionRef = useRef<HTMLDivElement>(null);
  ...
  // Data fetching - Activity timeline (график)
  const { data: timelineData, isLoading: isTimelineLoading } = useQuery({
    queryKey: ["user", "activityTimeline"],
    queryFn: () => apiGetActivityTimeline(6),
    enabled: !isGuest,
    staleTime: 5 * 60 * 1000,
  });
        ...
        <section className="dashboard-home">
          ...
          <div className="dashboard-home__container">
            {isGuest ? (
              ...
              <div className="mx-auto my-8 max-w-3xl px-1 sm:px-0 text-center">
                <div className="border-2 border-black bg-gray-900 p-8 shadow-[4px_4px_0_0_#000000]">
                  ...
                  <p className="text-gray-400 text-sm mb-6 max-w-md mx-auto">
                    ...
                    участвовать в баттлах и находить книги по вкусу с помощью
                    ИИ.
                  </p>
                  <button
              ...
              <>
                {/* Моя активность: график + статистика + уровень + достижения */}
                    ...
                    <div className="mt-4 grid items-start gap-4 lg:grid-cols-[minmax(0,1fr)_320px]">
                      <div className="space-y-4">
                        <MemoizedUserActivityStats
                          ...
                          totalActiveMinutes={stats?.totalActiveMinutes ?? 0}

...
const btnActive = "text-[#c1fffe]";
const btnInactive = "text-white/40 hover:text-white active:text-white";
        ...
        >
          ...
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 rounded-lg border border-white/10 bg-white/5">
              ...
              <span className="w-7 text-center text-[11px] font-black tabular-nums text-white/80">
                {height}
              </span>
              <button
                type="button"
          ...
          <div className="mb-3 flex items-center justify-between">
            ...
            <div className="flex items-center gap-1 rounded-lg border border-white/10 bg-white/5">
              ...
              <span className="w-7 text-center text-[11px] font-black uppercase tabular-nums text-white/80">
                {labelSize}
              </span>
              <button
                type="button"

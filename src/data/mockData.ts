...
export const TEMPLATES: TemplateItem[] = [
  ...
  },
  {
    ...
    uses: "1k",
    author: "BookStrata",
    image: "/images/books/master-i-margarita.webp",
    size: "large",
    type: "starter",
    badge: { text: "Попробовать", color: "accent-orange" },
    borderColor: "accent-orange",
    templateData: {
      title: "Школьная программа: шедевр или пытка?",
      description:
        "Классика, которую мы все проходили. Теперь решайте вы — шедевр или пытка?",
      type: "starter",
      isPublic: false,
      tiers: [
        { id: "tier_masterpiece", name: "Шедевр", color: "#ef4444", order: 1 },
        { id: "tier_liked", name: "Осилил, понравилось", color: "#f97316", order: 2 },
        { id: "tier_skimmed", name: "Читал по диагонали", color: "#eab308", order: 3 },
        { id: "tier_dnf", name: "Так и не дочитал", color: "#64748b", order: 4 },
      ],
      defaultBooks: [
        {
          title: "Мастер и Маргарита",
          author: "Михаил Булгаков",
          coverImageUrl: "/images/books/master-i-margarita.webp",
          description: "Сатана приезжает в Москву, и начинается хаос.",
          defaultTierId: "tier_masterpiece",
        },
        {
          title: "Преступление и наказание",
          author: "Фёдор Достоевский",
          coverImageUrl: "/images/books/prestuplenie-i-nakazanie.webp",
          description: "Раскольников проверяет теорию о сверхчеловеке.",
          defaultTierId: "tier_masterpiece",
        },
        {
          title: "Война и мир",
          author: "Лев Толстой",
          coverImageUrl: "/images/books/voyna-i-mir.webp",
          description: "Эпопея, которую осилили не все.",
          defaultTierId: "tier_masterpiece",
        },
        {
          title: "Анна Каренина",
          author: "Лев Толстой",
          coverImageUrl: "/images/books/anna-karenina.webp",
          description: "Все счастливые семьи похожи друг на друга.",
          defaultTierId: "tier_liked",
        },
        {
          title: "Братья Карамазовы",
          author: "Фёдор Достоевский",
          coverImageUrl: "/images/books/bratya-karamazovy.webp",
          description: "Три брата, один отец и вопрос о Боге.",
          defaultTierId: "tier_liked",
        },
        {
          title: "Тихий Дон",
          author: "Михаил Шолохов",
          coverImageUrl: "/images/books/tikhiy-don.webp",
          description: "Казачество в огне революции.",
          defaultTierId: "tier_skimmed",
        },
        {
          title: "Сто лет одиночества",
          author: "Габриэль Гарсиа Маркес",
          coverImageUrl: "/images/books/sto-let-odinochestva.webp",
          description: "Магический реализм во всей красе.",
          defaultTierId: "tier_skimmed",
        },
        {
          title: "Доктор Живаго",
          author: "Борис Пастернак",
          coverImageUrl: "/images/books/doktor-zhivago.webp",
          description: "Любовь и революция глазами поэта.",
          defaultTierId: "tier_dnf",
        },
        {
          title: "Тёмные аллеи",
          author: "Иван Бунин",
          coverImageUrl: "/images/books/temnye-allei.webp",
  ...
  },
  {
    ...
    uses: "1k",
    author: "BookStrata",
    image: "/images/books/shantaram.webp",
    size: "standard",
    type: "starter",
    badge: { text: "Попробовать", color: "accent-orange" },
    borderColor: "accent-orange",
    templateData: {
      title: "Бестселлеры: хайп или шедевр?",
      description:
        "Книги, о которых все говорят. Вынесите свой вердикт — хайп или шедевр?",
      type: "starter",
      isPublic: false,
      tiers: [
        { id: "tier_s", name: "S — шедевр", color: "#ef4444", order: 1 },
        { id: "tier_a", name: "A — достойно", color: "#f97316", order: 2 },
        { id: "tier_b", name: "B — среднячок", color: "#eab308", order: 3 },
        { id: "tier_c", name: "C — переоценено", color: "#64748b", order: 4 },
      ],
      defaultBooks: [
        {
          title: "Убить пересмешника",
          author: "Харпер Ли",
          coverImageUrl: "/images/books/ubit-peresmeshnika.webp",
          description: "Классика о расизме глазами ребёнка.",
          defaultTierId: "tier_s",
        },
        {
          title: "Тень ветра",
          author: "Карлос Руис Сафон",
          coverImageUrl: "/images/books/shadow-wind.webp",
          description: "Мистический роман о Кладбище забытых книг.",
          defaultTierId: "tier_s",
        },
        {
          title: "Шантарам",
          author: "Грегори Дэвид Робертс",
          coverImageUrl: "/images/books/shantaram.webp",
          description: "Беглец в индийских трущобах.",
          defaultTierId: "tier_a",
        },
        {
          title: "Жизнь Пи",
        ...
        },
        {
          ...
          author: "Эрин Моргенштерн",
          coverImageUrl: "/images/books/circus.webp",
          description: "Цирк, открытый только ночью.",
          defaultTierId: "tier_b",
        },
        {
          title: "Щегол",
          author: "Донна Тартт",
          coverImageUrl: "/images/books/schegol.webp",
          description: "Картина, связавшая две жизни.",
          defaultTierId: "tier_b",
        },
        {
          title: "Бегущий за ветром",
          author: "Халед Хоссейни",
          coverImageUrl: "/images/books/beguschiy-za-vetrom.webp",
          description: "Дружба и предательство в Афганистане.",
          defaultTierId: "tier_b",
        },
        {
          title: "Код да Винчи",
          author: "Дэн Браун",
          coverImageUrl: "/images/books/kod-da-vinchi.webp",
          description: "Тайна, спрятанная в картинах Леонардо.",
          defaultTierId: "tier_c",
        },
      ],
    },
  ...
  {
    id: 103,
    title: "С ЧЕГО НАЧАТЬ ФЭНТЕЗИ",
    category: "Фэнтези",
    categoryId: "fantasy",
    uses: "1k",
    author: "BookStrata",
    image: "/images/books/vlastelin-kolets.webp",
    size: "standard",
    type: "starter",
    badge: { text: "Попробовать", color: "accent-orange" },
    borderColor: "accent-orange",
    templateData: {
      title: "С чего начать фэнтези",
      description:
        "Путеводитель по жанру для новичков — от лёгких входов до тяжёлой артиллерии.",
      type: "starter",
      isPublic: false,
      tiers: [
        { id: "tier_start", name: "Начни с этого", color: "#8b5cf6", order: 1 },
        { id: "tier_classic", name: "Классика жанра", color: "#6366f1", order: 2 },
        { id: "tier_advanced", name: "На любителя", color: "#0ea5e9", order: 3 },
        { id: "tier_pro", name: "Для профи", color: "#64748b", order: 4 },
      ],
      defaultBooks: [
        {
          title: "Гарри Поттер и философский камень",
          author: "Дж. К. Роулинг",
          coverImageUrl: "/images/books/garri-potter-i-filosofskiy-kamen.webp",
          description: "Идеальный вход в жанр для любого возраста.",
          defaultTierId: "tier_start",
        },
        {
          title: "Властелин Колец",
          author: "Дж. Р. Р. Толкин",
          coverImageUrl: "/images/books/vlastelin-kolets.webp",
          description: "Фундамент всего жанра. Хоббит, кольцо, эпос.",
          defaultTierId: "tier_start",
        },
        {
          title: "Ведьмак. Последнее желание",
          author: "Анджей Сапковский",
          coverImageUrl: "/images/books/vedmak-poslednee-zhelanie.webp",
          description: "Славянское фэнтези в лучшем виде.",
          defaultTierId: "tier_classic",
        },
        {
          title: "Хроники Нарнии. Лев, колдунья и платяной шкаф",
          ...
          coverImageUrl: "/images/books/khroniki-narnii-lev-koldunya-i-platyanoy.webp",
          description: "Детская классика, которую любят взрослые.",
          defaultTierId: "tier_classic",
        },
        {
          title: "Имя ветра",
          author: "Патрик Ротфусс",
          coverImageUrl: "/images/books/imya-vetra.webp",
          description: "История о музыканте, маге и легенде.",
          defaultTierId: "tier_advanced",
        },
        {
          title: "Игра престолов",
          author: "Джордж Р. Р. Мартин",
          coverImageUrl: "/images/books/igra-prestolov.webp",
          description: "Тёмное фэнтези: интриги, драконы, зима.",
          defaultTierId: "tier_advanced",
        },
        {
          title: "Путь королей",
          ...
          coverImageUrl: "/images/books/put-koroley.webp",
          description: "Эпическая сага для тех, кому мало Толкина.",
          defaultTierId: "tier_pro",
        },
        {
          title: "Колесо Времени. Око мира",
          author: "Роберт Джордан",
          coverImageUrl: "/images/books/koleso-vremeni-oko-mira.webp",
          description: "14 томов. Если готовы — добро пожаловать.",
          defaultTierId: "tier_pro",
        },
      ],
    },

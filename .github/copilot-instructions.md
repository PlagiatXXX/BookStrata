# BookStrata — Инструкции для AI Агентов

## 🎯 Обзор проекта

**BookStrata** — полнофункциональное full-stack веб-приложение (React 19 + Fastify 5.7) для создания и управления интерактивными рейтингами книг (tier lists). Система поддерживает drag-and-drop редактирование, шаблоны, сообщество, лайки и AI-генерацию аватаров.

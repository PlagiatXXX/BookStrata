 ...
 * 3 literary (обзорные) + 16 curated (SEO-семантическое ядро).
 * Наполнены контентом: топ-фэнтези, детективы+триллеры, фантастика, лучшие всех времён.
 * Остальные — заглушки (isPublished: false).
 * Опубликуй через админку, когда добавишь контент.
 */
...
<ul>
  ...
  // ===== Curated — SEO-семантическое ядро =====
  {
    slug: "top-fantasy",
    ...
    books: {
      ...
      b2: { id: "b2", title: "Гарри Поттер и философский камень", author: "Дж. К. Роулинг", coverImageUrl: "/images/collections/curated/top-fantasy/astral-library.jpeg", description: "Первая книга о мальчике-волшебнике." },
      b3: { id: "b3", title: "Игра престолов", author: "Джордж Р. Р. Мартин", coverImageUrl: "/images/collections/curated/top-fantasy/house-lasyr.jpeg", description: "Политические интриги в мире Вестероса." },
  ...
  },
  {
    ...
    order: 12,
    tiers: {
      s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["tr1", "tr2", "tr3", "tr4", "tr5"] },
      a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["tr6", "tr7", "tr8", "tr9", "tr10"] },
      b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["tr11", "tr12", "tr13", "tr14", "tr15"] },
      c: { id: "c", title: "Средне", color: "#84cc16", bookIds: ["tr16", "tr17", "tr18", "tr19", "tr20"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {
  ...
  // ===== Новые =====
  {
    ...
    order: 15,
    tiers: {
      s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["h1", "h2", "h3"] },
      a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["h4", "h5", "h6"] },
      b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["h7", "h8", "h9"] },
      c: { id: "c", title: "Средне", color: "#84cc16", bookIds: ["h10", "h11", "h12"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {
  ...
  },
  {
    ...
    order: 16,
    tiers: {
      s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["rf1", "rf2", "rf3"] },
      a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["rf4", "rf5", "rf6"] },
      b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["rf7", "rf8", "rf9"] },
      c: { id: "c", title: "Средне", color: "#84cc16", bookIds: ["rf10", "rf11", "rf12"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {
  ...
  },
  {
    ...
    order: 19,
    tiers: {
      s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["p1", "p2", "p3"] },
      a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["p4", "p5", "p6"] },
      b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["p7", "p8", "p9"] },
      c: { id: "c", title: "Средне", color: "#84cc16", bookIds: ["p10", "p11", "p12"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {
  ...
  },
  {
    ...
    order: 22,
    tiers: {
      s: { id: "s", title: "Вершина", color: "#ef4444", bookIds: ["b1", "b2"] },
      a: { id: "a", title: "Шедевр", color: "#f97316", bookIds: ["b3", "b4"] },
      b: { id: "b", title: "Классика", color: "#eab308", bookIds: ["b5"] },
      c: { id: "c", title: "Значимо", color: "#84cc16", bookIds: ["b6"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {
  ...
  },
  {
    ...
    order: 24,
    tiers: {
      s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["hn1", "hn2", "hn3", "hn4", "hn5"] },
      a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["hn6", "hn7", "hn8", "hn9", "hn10"] },
      b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["hn11", "hn12", "hn13", "hn14", "hn15"] },
      c: { id: "c", title: "Средне", color: "#84cc16", bookIds: ["hn16", "hn17", "hn18", "hn19", "hn20"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {
  ...
  },
  {
    ...
    order: 31,
    tiers: {
      s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["rs1", "rs2", "rs3", "rs4", "rs5"] },
      a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["rs6", "rs7", "rs8", "rs9", "rs10"] },
      b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["rs11", "rs12", "rs13", "rs14", "rs15"] },
      c: { id: "c", title: "Средне", color: "#84cc16", bookIds: ["rs16", "rs17", "rs18", "rs19", "rs20"] },
    },
    tierOrder: ["s", "a", "b", "c"],
    books: {

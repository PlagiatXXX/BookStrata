...
export async function templatesController(
  ...
  fastify.get(
    "/templates",
    async (
      req: FastifyRequest<{ Headers: AuthHeaders }>,
      res: FastifyReply,
    ) => {
      try {
  ...
  fastify.put(
    ...
    async (
      ...
      try {
        ...
        if (
          error.message ===
          "Unauthorized: You can only update your own templates"
        ) {
  ...
  fastify.delete(
    ...
    async (
      ...
      try {
        ...
        if (
          error.message ===
          "Unauthorized: You can only delete your own templates"
        ) {
          return res.status(403).send({ error: error.message });
        }
  ...
  fastify.post(
    ...
    async (
      ...
      try {
        ...
        const newList = await service.useTemplate(
          id,
          String(userId),
          req.body.newListTitle,
        );

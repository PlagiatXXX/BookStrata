  ...
  fastify.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        return reply.code(201).header("Location", `/api/news/${article.id}`).send({ data: { message: "Новость создана" } });
      } catch (error) {
  ...
  fastify.put(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        return reply.send({ data: { message: "Новость обновлена", article } });
      } catch (error) {
  ...
  fastify.delete(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        return reply.send({ data: { message: "Новость удалена" } });
      } catch (error) {
  ...
  fastify.post(
    ...
    async (request: FastifyRequest, reply: FastifyReply) => {
      try {
        ...
        return reply.send({ data: { message: "Статус публикации изменён", article } });
      } catch (error) {

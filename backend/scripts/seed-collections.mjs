...
<ul>
  ...
  },
  {
    ...
    isPublished: true,
    order: 35,
    tiers: { s: { id: "s", title: "Шедевр", color: "#ef4444", bookIds: ["c1", "c2"] }, a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["c3", "c4"] }, b: { id: "b", title: "Хорошо", color: "#eab308", bookIds: ["c5", "c6"] } },
    tierOrder: ["s", "a", "b"],
    books: {
  ...
  },
  {
    ...
    isPublished: true,
    order: 36,
    tiers: { s: { id: "s", title: "Must read", color: "#ef4444", bookIds: ["y1", "y2"] }, a: { id: "a", title: "Отлично", color: "#f97316", bookIds: ["y3", "y4"] }, b: { id: "b", title: "Интересно", color: "#eab308", bookIds: ["y5"] } },
    tierOrder: ["s", "a", "b"],
    books: {
